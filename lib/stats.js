            ...
            players.forEach(function(player) {
                ...
                bookshelf.knex
                    ...
                    .then(function(res) {
                        ...
                        var games = res.map(function(game) {
                            return game.id;
                        });

                        games.forEach(function(current, i) {

                            var previous = games[i - 1];
                            var isConsecutive = current === (previous + 1);
                            var isFirst = i === 0;

                            if(isConsecutive || isFirst) {
                                wins ++;
                            }
